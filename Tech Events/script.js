...
document.addEventListener('DOMContentLoaded', () => {
    // Initialize the background slideshow using common.js function
    initBackgroundSlideshow(backgroundImages);
...
const eventDetails = {
    'Web Development Workshop': {
        ...
        date: 'June 15, 2025',
        location: 'IBM Conference Hall, GLAU',
        price: '₹299',
...
function verifyPayment() {
    ...
    if (verifyPaymentBtn) {
        ...
        verifyPaymentBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> Verifying...';
    }
    ...
    setTimeout(() => {
        ...
        if (success) {
            ...
            if (verifyPaymentBtn) {
                verifyPaymentBtn.disabled = true;
                verifyPaymentBtn.innerHTML = '<i class="fas fa-check-circle"></i> Payment Verified';
            }
            ...
            if (verifyPaymentBtn) {
                ...
                verifyPaymentBtn.innerHTML = '<i class="fas fa-check-circle"></i> I\'ve Made the Payment';
            }
        }
    }, 2000);
}
...
function setupRegistrationForm() {
    ...
    registrationForm.addEventListener('submit', function(event) {
        ...
        // Gather form data
        const formData = {
            eventName: document.getElementById('eventTitle').textContent.replace('Register for ', ''),
            name: document.getElementById('name').value,
            email: document.getElementById('email').value,
            phone: document.getElementById('phone').value,
            price: document.getElementById('eventPrice').textContent
        };
        ...
        setTimeout(() => {
            ...
            if (paymentStatus) {
                paymentStatus.textContent = 'Registration successful! Check your email for confirmation.';
                paymentStatus.className = 'payment-status success';
            }
